...
├❏ Limit:+10
├❏ PremLimit:+5
├❏ Level Up:${getLevel} > ${getLevelingLevel(sender)}
╰─────────────────────╯\`\`\``
}
...
return `Selamat ${tampilHari} @├${player.split("@")[0]}\n        *「 ${fake}  」* 
